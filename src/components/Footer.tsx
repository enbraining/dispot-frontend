    ...
    <footer className="w-full border-t border-gray-100 dark:border-zinc-800">
      <div className="max-w-6xl mx-auto px-5 sm:px-8 py-6 flex items-center justify-between text-xs text-gray-400 dark:text-zinc-500">
        <div className="flex items-center gap-4">
          ...
          <Link href="/terms" className="hover:text-gray-600 dark:hover:text-zinc-300 transition-colors">이용약관</Link>
          <Link href="/privacy" className="hover:text-gray-600 dark:hover:text-zinc-300 transition-colors">개인정보처리방침</Link>
        </div>
        <a
